...
import fila_prioridade.DefaultComparator;
import fila_prioridade.PriorityQueue;
import fila_prioridade.Entry;
import position.Position;
import exceptions.EmptyPriorityQueueException;
import exceptions.InvalidKeyException;
import arvore_binaria.ArrayListCompleteBT;
import arvore_binaria.CompleteBinaryTree;
...
public class HeapPriorityQueue<K, V> implements PriorityQueue<K, V> {
	...
	public HeapPriorityQueue() {
		heap = new ArrayListCompleteBT<Entry<K, V>>(); 
